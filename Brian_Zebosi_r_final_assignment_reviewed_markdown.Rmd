...
#own visualization
```{r}
posit_melt <- melt(position, "Chromosome", "candidate.random") 
ggplot(posit_melt)+geom_bar(aes(x=Chromosome, fill = value))+ggtitle("candidate vs random for each chromosome")+labs(x = "chromosome", y ="snp_count")
```
